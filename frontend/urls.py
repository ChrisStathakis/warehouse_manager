...
from .views import (HomepageView, CostumerListView, CreateOrderFromCostumerView,
                    ...
                    CostumerHomepageView, print_costumer_history_view
                    )
...
from .public_views import public_product_view, ajax_search_products, public_category_products_view
...
urlpatterns = [
    ...
    path('print-customer/<int:pk>/', print_costumer_history_view, name='print_costumer_history_view'),
    ...
    path('public/products/', public_product_view, name="public_products",),
    path("public/category-products/<int:pk>/", public_category_products_view, name='public_category'),
