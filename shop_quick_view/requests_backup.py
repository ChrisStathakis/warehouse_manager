...
BASE_URL = 'http://127.0.0.1:8000/backups/'



def fetch_vendors():
    handle_url(f'{BASE_URL} + vendors/', 'vendors.xls')
...
def fetch_orders():
    ...
    taxes_modifier = ['http://127.0.0.1:8000/backups/taxes-modifier/', 'taxes_modifiers.xls']
...
def customers():
    customers = ['http://127.0.0.1:8000/backups/invoice-items/', 'invoice_items.xls']
    customers_details = ['http://127.0.0.1:8000/backups/my-cards/', 'my_cards.xls']
    payment_invoices = ['http://127.0.0.1:8000/backups/customers/', 'customers_details.xls']
    payment_items = ['http://127.0.0.1:8000/backups/customers-details/', 'taxes_modifiers.xls']
    my_cars = ['http://127.0.0.1:8000/backups/payment-invoices/', 'payment_invoices.xls']
